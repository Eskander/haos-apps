...
![CI](https://img.shields.io/github/actions/workflow/status/Eskander/ha-addon-homer/.github/workflows/ci-cd.yml)
...
![Pulls](https://img.shields.io/badge/dynamic/json?url=https://ghcr-badge.elias.eu.org/api/Eskander/ha-addon-homer/ha-addon-homer&query=downloadCount&label=Pulls)
